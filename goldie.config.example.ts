...
const config: GoldieConfig = {
  ...
  // Google Play screenshots too: add "android-phone" to devices, start an
  ...
  devices: ["iphone-6.9"], // keys from src/specs.ts; "ipad-13" for the 13" iPad, "android-phone" for Google Play
  locales: ["en-US"],
  appearance: "light",
